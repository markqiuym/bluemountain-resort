...
<head>
	...
	<!-- Site Properties -->
	<title>About - Mountain Resort</title>
...
<body class="impx-body" id="top">
		...
		<div class="uk-container">
			...
			<div class="" data-uk-grid>
				<div class="uk-width-3-5@xl uk-width-3-5@l uk-width-1-1@m">
					...
					<p class="uk-text-muted impx-text-large uk-margin-remove">We're in the business of Hotel & Resort.
					</p>
					<p class="impx-text-large">Doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo
						inventore veritatis et quasi architecto beatae vitae dicta sunt in reprehenderit in voluptate
						velit esse dolore eu At quicum ioca seria, ut dicitur, quicum arcana, quicum occulta omnia? Quae
						fere omnia.</p>
					<p class="uk-margin-bottom data-uk-dropcap">At vero eos et accusamus et iusto odio dignissimos
						...
						deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum.</p>

					<div class="uk-child-width-1-2@xl uk-child-width-1-2@l uk-child-width-1-2@m uk-child-width-1-2@s"
						data-uk-grid>
						<div>
					...
					<div class="" data-uk-grid>
						...
						<div class="uk-width-1-1">
							...
							<div class="uk-child-width-1-3@xl uk-child-width-1-3@l uk-child-width-1-3@m uk-child-width-1-1@s uk-grid-small"
								data-uk-grid>
								<div>
									<!-- network location #1 -->
	...
	<!-- HISTORY LIST -->
	<div
		class="uk-padding uk-padding-remove-horizontal uk-position-relative bg3 impx-section-history style2 uk-position-relative no-margin uk-background-fixed uk-background-center-center uk-height-1-1">
		<div class="impx-overlay dark"></div>

		<div class="uk-container uk-container-expand uk-position-relative impx-padding-remove-right uk-light">
			<ul class="uk-child-width-1-4@xl uk-child-width-1-4@l uk-child-width-1-2@m uk-child-width-1-2@s history-list"
				data-uk-grid>
				<li class="uk-padding-large uk-padding-remove-vertical">
					...
					<div class="uk-position-relative impx-history-item">
						...
						<p class="uk-margin-remove impx-text-large impx-text-light">Vestri haec verecundius, illi
							fortasse.</p>
						<p class="uk-margin-remove-bottom impx-text-lighter">Lorem ipsum dolor sit amet, consectetur
							adipiscing Restincta enim sitis stabilitatem voluptatis habet, inquit, illa autem voluptas
							ipsius restinctionis in motu est. Itaque quantum adiit periculum! ad honestatem enim illum.
						</p>
					</div>
		...
		<div class="uk-container">
			<div class="uk-grid">
				...
				<div class="uk-width-2-3@xl uk-width-2-3@l uk-width-1-2@m">
					...
					<p class="impx-text-large uk-margin-medium-bottom uk-margin-small-top">Quo modo autem optimum, si
						bonum praeterea nullum est? Sed eum qui audiebant, quoad poterant, defendebant sententiam suam.
						Quod si ita se habeat, non possit beatam praestare vitam sapientia</p>
					<!-- highlight items -->
					<ul class="uk-child-width-1-2@xl uk-child-width-1-2@l uk-child-width-1-2@m uk-child-width-1-2@s impx-features-hl uk-margin-top uk-grid-match uk-flex-center uk-margin-medium-bottom"
						data-uk-grid>
						<!-- reason items  -->
						<li>
							<!-- reason item #1 -->
							<div class="uk-grid-medium" data-uk-grid>
								...
								<div
									class="uk-width-expand@xl uk-width-expand@l uk-width-expand@l uk-width-auto@s impx-margin-top-remove">
									<h5 class="uk-margin-remove">Best Value for Family</h5>
									<p class="uk-margin-small-top"> Si autem id non concedatur, non continuo vita beata
										tollitur. Ab his oratores, ab his dolore esse, alterum cum voluptate.</p>
								</div>
							</div>
						...
						<li>
							...
							<div class="uk-grid-medium" data-uk-grid>
								...
								<div
									class="uk-width-expand@xl uk-width-expand@l uk-width-expand@l uk-width-1-1@s impx-margin-top-remove">
